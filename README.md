...
### その他実務で見たもの
  ...
  - [attr_accessor](https://qiita.com/Hassan/items/0e034a1d42b2335936e6)
     - Railsでのマイグレーションファイルを作成する際にも自動で使われているはず
        `User.name`で値を取得したり書き換えたりできるのはattr_accessorのおかげ
  ...
  - [RubyのModuleの使い方](https://qiita.com/shiopon01/items/fd6803f792398c5219cd)
    - ※重要モジュールで名前空間やインスタンスの生成でinitializeとセットでよく使う
  ...
  - [module](https://style.potepan.com/articles/16207.html)※モジュールと使うことが多い
